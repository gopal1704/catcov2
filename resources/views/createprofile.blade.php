...
<select id="title" class="form-control">
    <option value="Mr.">Mr.</option>
                ...
                <div class="col-md-5">
                        ...
                        <input id="lastName" type="text" class="form-control{{ $errors->has('firstName') ? ' is-invalid' : '' }}" name="email" value="{{ old('email') }}" required >
            ...
            <div class="form-group row">
                    ...
                    <div class="form-group row">
                            ...
                            <div class="col-md-4">
                                    <label for="address" class="col-sm-4 col-form-label text-md-right">{{ __('City') }}</label>

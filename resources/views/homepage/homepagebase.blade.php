                    ...
                    <div class="rd-navbar-nav-wrap">
                     ...
                     <li  ><a href="/about"><span>About Us</span></a>
                       ...
                       <!--        <li <?php if($page == 'privacy') { echo "class='active'"; } ?>><a href="privacy.php"><span>Privacy policy</span></a>
                        ...
                        <li ><a href="/invest"><span>Invest</span></a>
                          </li>
                          <!-- <li <?php if($page == 'disclaimer') { echo "class='active'"; } ?>><a href="disclaimer.php"><span>Disclaimer</span></a>
                          </li> -->
                        <li ><a href="/tc"><span>Terms & conditions</span></a>
                          </li>
    
    
    <li>  <a href="/login" style="color:#fff"><span>Login</span></a></li>
    <li><a href="/register" style="color:#fff"><span>Sign up</span></a></li>

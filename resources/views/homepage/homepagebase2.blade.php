          ...
          <nav class="rd-navbar rd-navbar-default rd-navbar-light" data-md-device-layout="rd-navbar-fixed" data-lg-device-layout="rd-navbar-static" data-lg-auto-height="true" data-md-layout="rd-navbar-fixed" data-lg-layout="rd-navbar-static" data-lg-stick-up="true">
            <div class="rd-navbar-inner">
              ...
              <div class="rd-navbar-panel">
                ...
                <!--Navbar Brand-->
                <div class="rd-navbar-brand"><a href="index.php"><img width='180' height='50' style='margin-left: -6px;' src='homepage/images/logo-inverse.png' alt=''/></a></div>
              </div>
              <div class="rd-navbar-menu-wrap">
                <div class="rd-navbar-nav-wrap">
                  <div class="rd-navbar-mobile-scroll">
                    <!--Navbar Brand Mobile-->
                    <div class="rd-navbar-mobile-brand"><a href="/"><img width='210' height='106' style='margin-left: -6px;' src='homepage/images/logo-inverse.png' alt=''/></a></div>
		      ...
		      <li <?php if($page == 'invest') { echo "class='active'"; } ?>><a href="/invest"><span>Invest</span></a>
		      </li>


                    <li <?php if($page == 'terms') { echo "class='active'"; } ?>><a href="/tc"><span>Terms & conditions</span></a>
                      </li>
...
s1.async=true;
s1.src='https://embed.tawk.to/5c60faa16cb1ff3c14cbe7ff/default';
s1.charset='UTF-8';
